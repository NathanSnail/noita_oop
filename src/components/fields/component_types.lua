...
---@field ParticleEmitter ParticleEmitterComponents
---@field Explosion ExplosionComponents
---@field Inventory InventoryComponents
---@field PathFinding PathFindingComponents
---@field MoveToSurfaceOnCreate MoveToSurfaceOnCreateComponents
---@field NinjaRope NinjaRopeComponents
---@field Teleport TeleportComponents
---@field AIAttack AIAttackComponents
---@field AI AIComponents
---@field Ability AbilityComponents
---@field AdvancedFishAI AdvancedFishAIComponents
---@field Altar AltarComponents
---@field AnimalAI AnimalAIComponents
---@field Arc ArcComponents
---@field AreaDamage AreaDamageComponents
---@field AttachToEntity AttachToEntityComponents
---@field Audio AudioComponents
---@field AudioListener AudioListenerComponents
---@field AudioLoop AudioLoopComponents
---@field BiomeTracker BiomeTrackerComponents
---@field BlackHole BlackHoleComponents
---@field Book BookComponents
---@field BossDragon BossDragonComponents
---@field BossHealthBar BossHealthBarComponents
---@field CameraBound CameraBoundComponents
---@field CardinalMovement CardinalMovementComponents
---@field CellEater CellEaterComponents
---@field CharacterCollision CharacterCollisionComponents
---@field CharacterData CharacterDataComponents
---@field CharacterPlatforming CharacterPlatformingComponents
---@field CharacterStats CharacterStatsComponents
---@field CollisionTrigger CollisionTriggerComponents
---@field ConsumableTeleport ConsumableTeleportComponents
---@field ControllerGoombaAI ControllerGoombaAIComponents
---@field Controls ControlsComponents
---@field CrawlerAnimal CrawlerAnimalComponents
---@field CutThroughWorldDoneHere CutThroughWorldDoneHereComponents
---@field DamageModel DamageModelComponents
---@field DamageNearbyEntities DamageNearbyEntitiesComponents
---@field DebugFollowMouse DebugFollowMouseComponents
---@field DebugLogMessages DebugLogMessagesComponents
---@field DebugSpatialVisualizer DebugSpatialVisualizerComponents
---@field DieIfSpeedBelow DieIfSpeedBelowComponents
---@field DroneLauncher DroneLauncherComponents
---@field DrugEffect DrugEffectComponents
---@field DrugEffectModifier DrugEffectModifierComponents
---@field ElectricCharge ElectricChargeComponents
---@field Electricity ElectricityComponents
---@field ElectricityReceiver ElectricityReceiverComponents
---@field ElectricitySource ElectricitySourceComponents
---@field EndingMcGuffin EndingMcGuffinComponents
---@field EnergyShield EnergyShieldComponents
---@field ExplodeOnDamage ExplodeOnDamageComponents
---@field FishAI FishAIComponents
---@field Flying FlyingComponents
---@field FogOfWarRadius FogOfWarRadiusComponents
---@field FogOfWarRemover FogOfWarRemoverComponents
---@field GameAreaEffect GameAreaEffectComponents
---@field GameEffect GameEffectComponents
---@field GameLog GameLogComponents
---@field GameStats GameStatsComponents
---@field GasBubble GasBubbleComponents
---@field GenomeData GenomeDataComponents
---@field Ghost GhostComponents
---@field GodInfo GodInfoComponents
---@field Gun GunComponents
---@field HealthBar HealthBarComponents
---@field HitEffect HitEffectComponents
---@field Hitbox HitboxComponents
---@field Homing HomingComponents
---@field Hotspot HotspotComponents
---@field IKLimbAttacker IKLimbAttackerComponents
---@field IKLimb IKLimbComponents
---@field IKLimbWalker IKLimbWalkerComponents
---@field IKLimbsAnimator IKLimbsAnimatorComponents
---@field Ingestion IngestionComponents
---@field InheritTransform InheritTransformComponents
---@field Interactable InteractableComponents
---@field Inventory2 Inventory2Components
---@field InventoryGui InventoryGuiComponents
---@field ItemAIKnowledge ItemAIKnowledgeComponents
---@field ItemAction ItemActionComponents
---@field ItemAlchemy ItemAlchemyComponents
---@field ItemChest ItemChestComponents
---@field Item ItemComponents
---@field ItemCost ItemCostComponents
---@field ItemPickUpper ItemPickUpperComponents
---@field ItemRechargeNearGround ItemRechargeNearGroundComponents
---@field ItemStash ItemStashComponents
---@field Kick KickComponents
---@field LaserEmitter LaserEmitterComponents
---@field Levitation LevitationComponents
---@field Lifetime LifetimeComponents
---@field Light LightComponents
---@field Lightning LightningComponents
---@field LimbBoss LimbBossComponents
---@field LiquidDisplacer LiquidDisplacerComponents
---@field LoadEntities LoadEntitiesComponents
---@field LocationMarker LocationMarkerComponents
---@field LooseGround LooseGroundComponents
---@field Lua LuaComponents
---@field MagicConvertMaterial MagicConvertMaterialComponents
---@field MagicXRay MagicXRayComponents
---@field ManaReloader ManaReloaderComponents
---@field MaterialAreaChecker MaterialAreaCheckerComponents
---@field MaterialInventory MaterialInventoryComponents
---@field MaterialSeaSpawner MaterialSeaSpawnerComponents
---@field MaterialSucker MaterialSuckerComponents
---@field MusicEnergyAffector MusicEnergyAffectorComponents
---@field NullDamage NullDamageComponents
---@field Orb OrbComponents
---@field PathFindingGridMarker PathFindingGridMarkerComponents
---@field PhysicsAI PhysicsAIComponents
---@field PhysicsBody2 PhysicsBody2Components
---@field PhysicsBodyCollisionDamage PhysicsBodyCollisionDamageComponents
---@field PhysicsBody PhysicsBodyComponents
---@field PhysicsImageShape PhysicsImageShapeComponents
---@field PhysicsJoint2 PhysicsJoint2Components
---@field PhysicsJoint2Mutator PhysicsJoint2MutatorComponents
---@field PhysicsJoint PhysicsJointComponents
---@field PhysicsKeepInWorld PhysicsKeepInWorldComponents
---@field PhysicsPickUp PhysicsPickUpComponents
---@field PhysicsRagdoll PhysicsRagdollComponents
---@field PhysicsShape PhysicsShapeComponents
---@field PhysicsThrowable PhysicsThrowableComponents
---@field PixelScene PixelSceneComponents
---@field PixelSprite PixelSpriteComponents
---@field PlatformShooterPlayer PlatformShooterPlayerComponents
---@field PlayerCollision PlayerCollisionComponents
---@field PlayerStats PlayerStatsComponents
---@field PositionSeed PositionSeedComponents
---@field Potion PotionComponents
---@field PressurePlate PressurePlateComponents
---@field Projectile ProjectileComponents
---@field RotateTowards RotateTowardsComponents
---@field SetLightAlphaFromVelocity SetLightAlphaFromVelocityComponents
---@field SetStartVelocity SetStartVelocityComponents
---@field ShotEffect ShotEffectComponents
---@field SimplePhysics SimplePhysicsComponents
---@field SineWave SineWaveComponents
---@field SpriteAnimator SpriteAnimatorComponents
---@field Sprite SpriteComponents
---@field SpriteOffsetAnimator SpriteOffsetAnimatorComponents
---@field SpriteParticleEmitter SpriteParticleEmitterComponents
---@field SpriteStains SpriteStainsComponents
---@field StatusEffectData StatusEffectDataComponents
---@field StreamingKeepAlive StreamingKeepAliveComponents
---@field Telekinesis TelekinesisComponents
---@field TeleportProjectile TeleportProjectileComponents
---@field TextLog TextLogComponents
---@field Torch TorchComponents
---@field UIIcon UIIconComponents
---@field UIInfo UIInfoComponents
---@field VariableStorage VariableStorageComponents
---@field Velocity VelocityComponents
---@field VerletPhysics VerletPhysicsComponents
---@field VerletWeapon VerletWeaponComponents
---@field VerletWorldJoint VerletWorldJointComponents
---@field Wallet WalletComponents
---@field WalletValuable WalletValuableComponents
---@field WorldState WorldStateComponents
---@field WormAI WormAIComponents
---@field WormAttractor WormAttractorComponents
---@field Worm WormComponents
---@field WormPlayer WormPlayerComponents
